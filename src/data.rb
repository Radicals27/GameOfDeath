...
def location_descriptions(index)
    descriptions = [
        "Your girlfriend, Linda, has been kidnapped! The local mafia are keeping her in the top level of the mysterious pagoda on the outskirts of town...  You head towards it...",
...
def speak(index, struck_limb, weak_limb)
    dialogues = [
        ["OW!", "Ow! My #{struck_limb}!", "I love my #{weak_limb}...", "Don't hit my weak #{weak_limb}!!", "Nooooo! My #{struck_limb}!", "Good thing I don't need my #{struck_limb}!"],
